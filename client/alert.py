...
class Alert():
    ...
    def setup(self):
        ...
        self.panel = arcade.load_texture(
            f"{DIR}/assets/images/dialog/glassPanel.png")
        self.btn_again_texture = arcade.load_texture(
            f"{DIR}/assets/images/common/blue_button/blue_button02.png")
        self.btn_again = Button("Again", self.btn_again_texture, popup_x +
                                POPUP_WIDTH // 2, popup_y + POPUP_HEIGHT // 2, 100, 50)
    ...
    def draw_background(self):
        arcade.draw_lrtb_rectangle_filled(
            0, SCREEN_WIDTH, SCREEN_HEIGHT, 0, (0, 0, 0, 50))
    ...
    def draw_popup(self, data):
        ...
        arcade.draw_text(self.pick_content(data), popup_x + 10, popup_y + POPUP_HEIGHT - 30,
                         arcade.color.BLACK, 30, width=POPUP_WIDTH - 20, align="center", anchor_x="left", anchor_y="top")
        self.btn_again.draw()
