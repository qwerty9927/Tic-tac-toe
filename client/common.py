...
class Button:
    ...
    def draw(self):
        arcade.draw_lrwh_rectangle_textured(self.x - self.button_width // 2, self.y -
                                            self.button_height // 2, self.button_width, self.button_height, self.texture)
        arcade.draw_text(self.text, self.x, self.y, arcade.color.BLACK,
