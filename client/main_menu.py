...
class MainMenu(arcade.View):
    ...
    def on_show_view(self):
        ...
        btn_start_vs_bot_texture = arcade.load_texture(f"{DIR}/assets/images/common/blue_button/blue_button02.png")
        btn_exit_texture = arcade.load_texture(f"{DIR}/assets/images/common/red_button/red_button01.png")

        # Load sound
        self.btn_start_sound = arcade.load_sound(f"{DIR}/assets/sounds/click1.wav")
        self.btn_exit_sound = arcade.load_sound(f"{DIR}/assets/sounds/click2.wav")
